...
export type SyncActionType = 
  ...
  | 'UPSERT_NOTE' // Added
  | 'DELETE_NOTE' // Added
  | 'UPSERT_DICTATION' // Added
  | 'DELETE_DICTATION' // Added
  | 'DELETE_STUDY_SET'
  | 'UPSERT_STUDY_SET'; // Added for Confidence/Anki sets
...
export type QuestionType = 'mcq' | 'truefalse' | 'typing' | 'scramble' | 'flashcard';
...
export interface QuestionCard {
  ...
  payload: McqPayload | TrueFalsePayload | TypingPayload | ScramblePayload | FlashcardPayload;
}
