...
const defaultAnkiSampleTable: Table = {
    id: 'default-anki-sample', name: 'Sample: Learn About SRS', columns: [srsTermCol, srsExplainCol, srsTagCol], rows: [
