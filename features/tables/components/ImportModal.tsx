            ...
            case 3: return (
                <div className="p-6">
                    ...
                    <div className="flex justify-end gap-2">
                        ...
                        <button onClick={handleConfirmBackupRestore} className="bg-primary-600 text-white font-semibold px-4 py-2 rounded-md hover:bg-primary-700">Restore Full Backup</button>
                    </div>
                </div>
            );
        }
