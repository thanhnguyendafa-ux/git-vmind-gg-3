    ...
    <div
      className={`
        ...
        ${isSelected 
          ...
          : 'hover:bg-secondary-100 dark:hover:bg-secondary-800 text-text-main dark:text-secondary-200'
        }
      `}
    ...
    >
      ...
      >
        {hasChildren && (
          <Icon 
            name="chevron-right" 
            className={`w-3 h-3 text-text-subtle transition-transform duration-200 ${isExpanded ? 'rotate-90' : ''}`} 
          />
        )}
      </div>
