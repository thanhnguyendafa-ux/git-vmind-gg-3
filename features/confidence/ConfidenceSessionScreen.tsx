...
const ConfidenceSessionScreen: React.FC = () => {
    ...
    return (
        <div className={`fixed inset-0 bg-background dark:bg-secondary-900 flex flex-col transition-colors duration-300 ${isFullscreen ? 'z-50 p-0' : 'p-4'}`}>
            <header className="w-full px-4 md:px-6 mb-4 flex-shrink-0">
                <div className="flex justify-between items-center text-text-subtle mb-2">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        >
                            <Icon name="x" className={isFullscreen ? "w-4 h-4" : "hidden"} /> 
                            <Icon name="arrows-pointing-out" className={!isFullscreen ? "w-4 h-4" : "hidden"} />
                        </button>
                        ...
                        <button onClick={() => setIsEndSessionConfirmOpen(true)} className="text-xs hover:text-text-main dark:hover:text-secondary-100 transition-colors">End Session</button>
                    </div>
                </div>
            ...
            {/* Main content area set to full width and flex grow */}
