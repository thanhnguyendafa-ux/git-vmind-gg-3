...
const SettingsScreen: React.FC = () => {
  ...
  const { 
      ...
      isPulling, 
      attemptNavigation, 
      triggerGlobalAction, // Added triggerGlobalAction
      backgroundSettings, 
  ...
  return (
    <div className="h-full overflow-y-auto bg-background dark:bg-secondary-900">
                ...
                <CardContent className="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div className="flex gap-3">
                            ...
                            <ThemeOption mode="pastel" label="Pastel" icon="flower" />
                        </div>
                    </div>
      ...
      {isSettingsDirty && (
          <div className="fixed bottom-20 left-1/2 -translate-x-1/2 z-40 animate-slideInUp">
