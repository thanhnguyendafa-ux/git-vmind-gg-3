...
const VmindChatModal: React.FC<VmindChatModalProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed bottom-24 right-5 z-40 w-full max-w-sm h-[70vh] max-h-[550px] bg-surface dark:bg-secondary-800 rounded-xl shadow-2xl flex flex-col border border-secondary-200 dark:border-secondary-700 animate-slideInUp">
