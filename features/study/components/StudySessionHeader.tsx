...
const StudySessionHeader: React.FC<StudySessionHeaderProps> = ({ 
    onQuit, userLevel, userXp, sessionXp, masteredCount, totalCount, elapsedSeconds, isSpeedMode, onToggleSpeedMode 
}) => {
    ...
    return (
        <header className="w-full max-w-4xl mx-auto p-3 flex items-center gap-4 text-sm">
