...
const AnkiSessionScreen: React.FC = () => {
    ...
    return (
        <div className="fixed inset-0 bg-background dark:bg-secondary-900 flex flex-col items-center p-4 transition-colors duration-300">
            ...
            <main className="flex-1 flex flex-col items-center w-full overflow-hidden relative px-4 md:px-6">
            ...
            {isAnswered && (
                <div className="fixed bottom-0 left-0 right-0 p-4 bg-surface dark:bg-secondary-800 border-t border-secondary-200 dark:border-secondary-700 shadow-[0_-5px_20px_rgba(0,0,0,0.2)] z-50 md:static md:w-full md:bg-transparent md:border-none md:shadow-none md:p-0 md:mt-4 animate-slideInUp">
             ...
             <footer className="w-full mt-4 hidden md:flex items-center justify-center text-xs text-text-subtle">
