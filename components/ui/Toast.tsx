...
const Toast: React.FC<ToastProps> = ({ message, type = 'info', actionText, onAction, onClose, duration = 7000 }) => {
  ...
  return (
    <div
      className={`fixed bottom-20 sm:bottom-5 left-1/2 -translate-x-1/2 z-50 transition-all duration-300 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
