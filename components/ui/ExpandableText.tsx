...
const ExpandableText: React.FC<ExpandableTextProps> = ({ text, typography, prefix }) => {
  ...
  }, [text, typography, isExpanded, prefix]);

  const style: React.CSSProperties = {
    ...typography,
    wordBreak: 'break-word',
    // The responsive font size can be handled here if needed,
    // but for now, we use the provided fixed size.
  };
